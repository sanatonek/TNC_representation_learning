...
if __name__=='__main__':
    ...
    t = np.random.randint(window_size, x.shape[-1] - window_size, len(x))
    x_train = np.array( [x[i, :, tt - window_size//2: tt + window_size//2] for i, tt in enumerate(t)] )
    ...
    t = np.random.randint(window_size, x.shape[-1] - window_size, len(x_test))
    x_test = np.array( [x_test[i, :, tt - window_size//2: tt + window_size//2] for i, tt in enumerate(t)] )
    # x_test = x_test[np.arange(len(x_test)), :, t - window_size//2: t + window_size//2]
